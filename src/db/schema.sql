CREATE TABLE IF NOT EXISTS orders (
  ...
  checkout_security_json JSON NULL,
  checkout_proof_digest CHAR(64) CHARACTER SET ascii COLLATE ascii_bin NULL,
  ...
  UNIQUE KEY uq_orders_checkout_proof_digest (checkout_proof_digest),
...
CREATE TABLE IF NOT EXISTS jobs (
  ...
  nexo_job_id VARCHAR(191) NULL,
  nexo_status VARCHAR(100) NULL,
  ...
  UNIQUE KEY uq_jobs_nexo_job_id (nexo_job_id),
